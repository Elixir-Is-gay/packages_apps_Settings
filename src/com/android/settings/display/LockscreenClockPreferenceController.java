...
public class LockscreenClockPreferenceController extends TogglePreferenceController {
    ...
    public int getAvailabilityStatus() {
        boolean isDepthClockEnabled = Settings.Secure.getInt(mContext.getContentResolver(), DEPTH_CLOCK_KEY, 0) != 0 || Settings.Secure.getInt(mContext.getContentResolver(), AUTO_DEPTH_CLOCK_KEY, 0) != 0;
        return isDepthClockEnabled ? CONDITIONALLY_UNAVAILABLE : AVAILABLE;
    }
