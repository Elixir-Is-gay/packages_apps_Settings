...
public class StorageDashboardFragment extends DashboardFragment
    ...
    private void applyCardLayout() {
        final Preference mASMPref = (Preference) findPreference("toggle_asm");
        final Preference mFreeSpacePref = (Preference) findPreference("free_up_space");
        if (mASMPref == null || mFreeSpacePref == null) {
            Log.i(TAG, "Preference is NULL!");
            return;
        }
        if (mASMPref.isVisible()) {
            mASMPref.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_top);
            mFreeSpacePref.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_bot);
        } else {
            mFreeSpacePref.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_mid2);
        }
    }
