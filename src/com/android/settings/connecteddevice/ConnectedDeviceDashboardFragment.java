...
public class ConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    private void applyCardLayout() {
        ...
        Preference mAddBtDevicePref = (Preference) mMainScreenPrefCat.findPreference("add_bt_devices");
        PreferenceCategory mPairNewDevicePref = (PreferenceCategory) mMainScreenPrefCat.findPreference("connected_device_list");
        if (mAddBtDevicePref != null) {
            if (mPairNewDevicePref.getPreferenceCount() != 0) {
                mAddBtDevicePref.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_bot);
            } else {
                mAddBtDevicePref.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_mid2);
            }
        }
    }
}
