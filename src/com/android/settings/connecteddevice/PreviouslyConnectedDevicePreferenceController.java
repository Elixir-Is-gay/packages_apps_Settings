...
public class PreviouslyConnectedDevicePreferenceController extends BasePreferenceController
    ...
    void updatePreferenceVisibility() {
        ...
        applyCardLayoutToCategory();
    }

    private void applyCardLayoutToCategory() {
        if (mPreferenceGroup == null ) {
            Log.e(TAG, "mPreferenceGroup is null!");
            return;
        }
        for (int i = 0; i < mPreferenceGroup.getPreferenceCount(); i++) {
            final Preference preference = mPreferenceGroup.getPreference(i);
            ...
            if (mSeeAllPreference.isVisible()) {
                if (mPreferenceGroup.getPreferenceCount() > 1) {
                    mSeeAllPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_bot);
                } else {
                    mSeeAllPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_mid2);
                }
            }
        }
    }
