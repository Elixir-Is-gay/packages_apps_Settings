    ...
    private void applyCardLayout(PreferenceGroup mPrefGroup) {
        ...
        for (String currentPref : prefList) {
            ...
            if (preference instanceof VolumeSeekBarPreference) {
                preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_volume_slider_mid);
            } else if (preference instanceof IncreasingRingVolumePreference) {
                preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_increasing_ring_mid);
            } else {
            ...
            if (count == 4) {
                if (preference instanceof VolumeSeekBarPreference) {
                    preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_volume_slider_bot);
                } else if (preference instanceof IncreasingRingVolumePreference) {
                    preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_increasing_ring_bot);
                } else {
            ...
            if (count == 5) {
                count = 1;
                if (preference instanceof VolumeSeekBarPreference) {
                    preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_volume_slider_top);
                } else if (preference instanceof IncreasingRingVolumePreference) {
                    preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_increasing_ring_top);
                } else {
        ...
        try {
            ...
            if (firstPreference instanceof VolumeSeekBarPreference) {
                firstPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_volume_slider_top);
            } else if (firstPreference instanceof IncreasingRingVolumePreference) {
                firstPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_increasing_ring_top);
            } else {
                firstPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_top);
            }

            if (lastPreference instanceof VolumeSeekBarPreference) {
                if (remainder == 1) {
                    lastPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_volume_slider_mid2);
                } else {
                    lastPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_volume_slider_bot);
                }
            } else if (lastPreference instanceof IncreasingRingVolumePreference) {
                if (remainder == 1) {
                    lastPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_increasing_ring_mid2);
                } else {
                    lastPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_increasing_ring_bot);
                }
            } else {
                if (remainder == 1) {
