...
public class ConfigureNotificationSettings extends DashboardFragment implements
    ...
    private void applyCardLayout() {
        ...
        PreferenceCategory mGeneralPrefCat = (PreferenceCategory) findPreference("general_notifications_category");
        PreferenceCategory mConvoPrefCat = (PreferenceCategory) findPreference("conversation_category");
        PreferenceCategory mNotificationLockPrefCat = (PreferenceCategory) findPreference("configure_notifications_lock");
        PreferenceCategory mAdvancedPrefCat = (PreferenceCategory) findPreference("advanced_section_header");
        applyCardLayoutToCategory(mGeneralPrefCat);
        applyCardLayoutToCategory(mConvoPrefCat);
        applyCardLayoutToCategory(mNotificationLockPrefCat);
        applyCardLayoutToCategory(mAdvancedPrefCat);
