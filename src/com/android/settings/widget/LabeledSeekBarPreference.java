...
public class LabeledSeekBarPreference extends SeekBarPreference {
    ...
    public LabeledSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mIconStartContentDescriptionId = styledAttrs.getResourceId(
                ...
                /* defValue= */ 0);
        layoutPos = styledAttrs.getInt(R.styleable.LabeledSeekBarPreference_layout_pos, 0);
        Log.i("LabeledSeekbarPreference", "Layout position :- " + Integer.toString(layoutPos));
        switch (layoutPos) {
            case 0: 
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_labeled_slider_mid2);
                break;
            case 1:
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_labeled_slider_top);
                break;
            case 2:
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_labeled_slider_mid);
                break;
            case 3:
                setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_labeled_slider_bot);
                break;
            default:
