...
class TextReadingPreviewController extends BasePreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        isDepthClock = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.LOCKSCREEN_DEPTH_CLOCK, 0) != 0 || Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.LOCKSCREEN_DEPTH_CLOCK_AUTO, 0) != 0;
