...
public class AppsPreferenceController extends BasePreferenceController implements
    ...
    public static final String TAG = "AppsPreferenceController";
    ...
    private void displayRecentApps() {
        if (mRecentAppsCategory != null) {
            ...
            for (String currentPref : prefList) {
                try {
                    final Preference preference = mRecentAppsCategory.findPreference(currentPref);
                    Log.i(TAG, "Setting layout for preference :- " + currentPref);
                    preference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_app_mid);
                } catch (Exception ex) {
            ...
            try {
                ...
                final Preference firstPreference = mRecentAppsCategory.findPreference(firstPref);
                //final Preference lastPreference = mRecentAppsCategory.findPreference(lastPref);
                firstPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_app_top);
                //lastPreference.setLayoutResource(org.elixir.resources.cardlayout.R.layout.preference_app_bot);
                mSeeAllPref.setLayoutResource(org.elixir.resources.cardlayout.R.layout.xd_pref_card_bot);
            } catch (Exception exe) {
